...
public class Assigmet5 {
	...
	static void copySheet()
	{
		...
		String strData = null;
		try {
			fin = new FileInputStream("C:\\Users\\Swapna\\Desktop\\Excelsheet5.xlsx");
			...
			fout = new FileOutputStream("C:\\Users\\Swapna\\Desktop\\Excelsheet5.xlsx");
			wb.write(fout);
		}catch(Exception e)
		{
