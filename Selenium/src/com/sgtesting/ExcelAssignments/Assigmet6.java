...
public class Assigmet6 {
	...
	static void copySheet()
	{
		...
		String strData = null;
		try {
			fin = new FileInputStream("C:\\Users\\Swapna\\Desktop\\Excelsheet6.xlsx");
			...
			fout = new FileOutputStream("C:\\Users\\Swapna\\Desktop\\Excelsheet6.xlsx");
			wb.write(fout);
		}catch(Exception e)
		{
