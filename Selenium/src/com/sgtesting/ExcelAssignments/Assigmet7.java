...
public class Assigmet7  {
	...
	static void copySheet()
	{
		...
		String strData = null;
		try {
			fin = new FileInputStream("C:\\Users\\Swapna\\Desktop\\Excelsheet7.xlsx");
			...
			fout = new FileOutputStream("C:\\Users\\Swapna\\Desktop\\Excelsheet7.xlsx");
			wb.write(fout);
		}catch(Exception e)
		{
